...
public partial class TabTraditionArtifactViewModel : ObservableObject,
    ...
    IRecipient<DeleteTraditionArtifactMessage>
{
    ...
    public TabTraditionArtifactViewModel()
    {
    ...
    public void AddArtifact(TraditionArtifact artifact)
    {
