...
namespace Magehelper.WPF
{
    public class Settings
    {
        ...
        public int SpellSoragePoints { get; set; }
            ...
            foreach (string file in artifactFiles.Append("tabSettings.json").Prepend("appSettings.json"))
            {
                switch (file)
                {
                    ...
                    case "appSettings.json":
                        ...
                        SpellSoragePoints = appSettings.SpellSoragePoints;
        ...
        public void SaveConfigFile()
        {
            ...
            {
                SpellSoragePoints = SpellSoragePoints,
        ...
        public void SetCurrentConfig()
        {
            ...
            Properties.Settings.Default.SpellStoragePoints = SpellSoragePoints;
